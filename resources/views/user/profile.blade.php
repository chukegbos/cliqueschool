...
<div class="row">
    <div class="col-lg-3 col-md-3 mail-list">
        <div class="card">
            <div class="card-body">
                <a href="{{ url('setup') }}" class="btn btn-rounded btn-primary waves-effect waves-light btn-block">Edit Profile</a>
            </div>
            <ul class="list-group list-group-full">
                <li class="list-group-item"><a href="javascript:void(0)?" onclick="hideDiv('profile')" class="text-muted"><i class="mdi mdi-account"></i> Profile</a> </li>
                <li class="list-group-item"><a href="javascript:void(0)?" onclick="hideDiv('biography')" class="text-muted"><i class="mdi mdi-file-document"></i> Biography</a> </li>
                <li class="list-group-item"><a href="javascript:void(0)?" onclick="hideDiv('skills')" class="text-muted"><i class="mdi mdi-file-document"></i> Skills</a></li>
                <li class="list-group-item"><a href="javascript:void(0)?" onclick="hideDiv('experience')" class="text-muted"><i class="mdi mdi-briefcase"></i> Experience</a></li>
                <li class="list-group-item"><a href="javascript:void(0)?" onclick="hideDiv('education')" class="text-muted"><i class="mdi mdi-school"></i> Education</a> </li>
                <!-- <li class="list-group-item"><a href="#" class="text-muted"><i class="mdi mdi-settings"></i> Settings</a></li> -->
            </ul>
        </div>
    </div>
    <div class="col-lg-9 col-md-9">
        ...
        <div class="card" id="biography" style="display:none">
            <div class="card-body  card2 pt-5">
                <div class="row">
                    <div class="col-lg-12 col-md-12 f-18 font-weight-bold text-uppercase">biography</div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
