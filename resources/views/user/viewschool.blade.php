        ...
        <div class="card" id="lectures" style="display:none">
            ...
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    @empty
                        <div class="col-md-12">
                            <p class="p-4 alert alert-info text-center">No lecture yet, click <a href="{{ url('user/my-school/lecture/create') }}/{{ $data['school']->school_code }}">here</a> to add lecture</p>
                        </div>
                    @endforelse 
                </div>
            </div>
