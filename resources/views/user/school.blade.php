                ...
                <tbody>
                    @foreach($schools as $school)
                        ...
                        <td>
                            ...
                            <td>
                                <span class="badge badge-light-{{ $school->getStatusColor() }}">{{$school->getStatus()}}</span>
                            </td>
                            <td>
                                <div class="overlay-edit">
                                    ...
                                    <button type="button" class="btn btn-icon btn-info" data-toggle="modal" data-target="#editSchoolModal{{$school->id}}">
                                        <i class="feather icon-edit"></i>
                                    </button>
                                    <button type="button" class="btn btn-icon btn-{{($school->status == 1)? 'danger' : 'success' }}"
                                    onclick="event.preventDefault(); document.getElementById('changeSatus{{$school->id}}').submit();">
                                        <i class="feather icon-Ban"></i>{{($school->status == 1)? 'Disable' : 'Enable' }}
                                    </button>
                                    <button type="button" onclick="event.preventDefault(); document.getElementById('deleteSchool{{$school->id}}').submit();" class="btn btn-icon btn-danger">
