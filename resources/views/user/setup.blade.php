        ...
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="page-header-title">
                    <h2 class="m-b-10">Account Settings</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
                <form method="POST" action="{{ url('setup') }}" enctype="multipart/form-data">
                    @csrf
                    <h4>Your {{ $setting->sitename }} Account</h4>
                    <p>This is your public presence on {{ $setting->sitename }}. You need a account to upload your paid courses, comment on courses, purchased by students, or earning.</p>
                    <div class="my-3">
                        <h4>Basic Profile</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" value="{{ Auth::user()->name }}" required="" maxlength="64" readonly="true">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="firstname" value="{{ Auth::user()->firstname }}"  required="" maxlength="64">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="lastname" value="{{ Auth::user()->lastname }}"  required="" maxlength="64">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input class="form-control" type="email" name="email" value="{{ Auth::user()->email }}"  required="" maxlength="64">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="tel" name="phone" value="{{ Auth::user()->phone }}"  required="" maxlength="64">
                                </div>
                            </div>
                    
                            <!-- <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Account Headline</label><small class="form-text text-muted float-right">Add a professional headline like, "Engineer at Cursus" or "Architect."</div>
                                    <input class="form-control" type="text" name="headline" value="{{ Auth::user()->headline }}">
                                </div>
                            </div> -->
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="3" id="description" name="description" class="form-control">{{ Auth::user()->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="basic_form">
                            <div class="nstting_content">
                                <div class="basic_ptitle">
                                    ...
                                    <p>Your emails are sent to <a href="https://gambolthemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="82e5e3efe0edeebbb6b1c2e5efe3ebeeace1edefac">[email&#160;protected]</a> To unsubscribe from an email, click the "Unsubscribe" link at the bottom of it. <a href="#">Learn more</a> about emails from Edututs+.</p>
                                </div>
                                <div class="ui toggle checkbox _1457s2">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="name" value="Joginder" id="id[name1]" required="" maxlength="64" placeholder="First Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="surname" value="Singh" id="id[surname1]" required="" maxlength="64" placeholder="Last Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="academyname" value="Gambolthemes" id="id_academy" required="" maxlength="64" placeholder="Academy Name">
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="addressname" value="#1234, Sks Nagar, Near MBD Mall, 141001 Ludhiana, Punjab, India" id="id_address1" required="" maxlength="64" placeholder="Address Line 1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="addressname2" id="id_address2" required="" maxlength="64" placeholder="Address Line 2">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="city" value="Ludhiana" id="id_city" required="" maxlength="64" placeholder="City">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="state" value="Punjab" id="id_state" required="" maxlength="64" placeholder="State / Province / Region">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="zip" value="141001" id="id_zip" required="" maxlength="64" placeholder="Zip / Postal Code">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="ui search focus mt-30">
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="phone" value="+911234567890" id="id_phone" required="" maxlength="12" placeholder="Phone Number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group return-departure-dts" data-method="payal">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="ui search focus mt-30">
                                                <div class="form-group">
                                                    <input class="form-control" type="email" name="emailaddress" value="" id="id_email" required="" maxlength="64" placeholder="Email address">
                                                </div>
                                            </div>
                                            <div class="ui search focus mt-20">
                                                <div class="form-group">
                                                    <input class="form-control" type="email" name="cemailaddress" value="" id="id_emailc" required="" maxlength="64" placeholder="Confirm email address">
                                                </div>
                                            </div>
                                ...
                                <div class="form-group return-departure-dts" data-method="payoneer">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="ui search focus mt-30">
                                                <div class="form-group">
                                                    <input class="form-control" type="email" name="emailaddress1" value="" id="id_email1" required="" maxlength="64" placeholder="Email address">
                                                </div>
                                            </div>
                                            <div class="ui search focus mt-20">
                                                <div class="form-group">
                                                    <input class="form-control" type="email" name="cemailaddress1" value="" id="id_emailc1" required="" maxlength="64" placeholder="Confirm email address">
                                                </div>
                                            </div>
                                            <button class="save_payout_btn" type="submit">Set Payout Account</button>
                                        </div>
                                ...
                                <div class="form-group return-departure-dts" data-method="swift">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="ui search focus mt-30">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="fullname" value="" id="id_fullname" required="" maxlength="64" placeholder="Full Name">
                                                </div>
                                            </div>
                                            <div class="ui search focus mt-15">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="uraddress" value="" id="id_address4" required="" maxlength="64" placeholder="Your Address">
                                                </div>
                                            </div>
                                            ...
                                            <div class="ui search focus mt-15">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="swiftcode" value="" id="id_swiftcode" required="" maxlength="64" placeholder="Swift-Code">
                                                </div>
                                            </div>
                                            <div class="ui search focus mt-15">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="banknumber" value="" id="id_banknumber" required="" maxlength="64" placeholder="Back Account Number">
                                                </div>
                                            </div>
                                            <div class="ui search focus mt-15">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="bankname" value="" id="id_bankname" required="" maxlength="64" placeholder="Back Name">
                                                </div>
                                            </div>
                                            <div class="ui search focus mt-15">
                                                <div class="form-group">
                                                    <input class="form-control" type="text" name="address5" value="" id="id_address5" required="" maxlength="64" placeholder="Back Address">
                                                </div>
                                            </div>
                                            <button class="save_payout_btn" type="submit">Set Payout Account</button>
                                        </div>
            ...
            <div class="tab-pane fade" id="pills-closeaccount" role="tabpanel" aria-labelledby="pills-closeaccount-tab">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="ui search focus mt-30">
                            <div class="form-group">
                                <input class="form-control" type="password" name="yourassword" id="id_yourpassword" required="" maxlength="64" placeholder="Enter Your Password">
                            </div>
